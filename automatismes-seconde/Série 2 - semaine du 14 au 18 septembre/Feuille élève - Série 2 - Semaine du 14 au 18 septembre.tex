...
\newcommand{\qcase}[1]{%
  \begin{tikzpicture}[baseline=0pt]
    ...
    \node[anchor=north west, circle, draw=inkC, line width=0.6pt,
          inner sep=1pt, minimum size=1.3em, font=\normalsize, text=inkC]
      at (0.05cm,1.8cm) {#1};
  \end{tikzpicture}%
}
...
\shortstack{{\Large\textcolor{qcmC}{A9}}\\[2pt]{\small Développer}\\[0pt]{\small Factoriser}} &
